  ...
  const renderPageNumbers = () => {
    ...
    const deviderComponent = () => (
      <div className="relative h-10 w-10 rounded-lg">
        <div className="absolute left-0 top-0 inline-flex h-10 w-10 items-center justify-center rounded-lg p-2">
          <div className="text-center font-['Poppins'] text-sm font-medium leading-normal tracking-tight">
            ...
          </div>
        </div>
      </div>
    ...
    >
      <div className="flex h-6 shrink grow basis-0 items-center justify-start">
        ...
        >
          ...
          <div className="font-['Poppins'] text-sm font-medium leading-normal tracking-tight">
            Previous
          </div>
        </button>
      </div>
      ...
      <div
        onClick={() => nextPage()}
        className="flex h-6 shrink grow basis-0 items-center justify-end"
      >
